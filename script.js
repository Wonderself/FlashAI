...
function initPortfolio() {
    ...
    const projects = [
        { title: 'Freenzy.io', type: 'SaaS IA tout-en-un', desc: 'Plateforme SaaS avec assistants IA, studio creatif, gestion de taches, email IA, et plus de 30 modules connectes.', color: '#00f0ff', tags: ['SaaS','IA','Automatisation'], stat: '30+ modules', img: 'assets/portfolio-freenzy.jpg', url: 'https://app.freenzy.io' },
        { title: 'Cinegen', type: 'Streaming & Cinema IA', desc: 'Plateforme de streaming cinema avec creation, financement et diffusion de films. Interface style Netflix premium.', color: '#ff006e', tags: ['Streaming','Cinema','IA'], stat: 'Netflix-like', img: 'assets/portfolio-cinegen.jpg', url: 'https://cinegen.188.245.182.200.sslip.io' },
        { title: 'GlamHouse', type: 'Immobilier & Blockchain', desc: 'Site immobilier eco-responsable avec tokenisation blockchain. Investissement et decouverte de maisons passives high-tech.', color: '#bf00ff', tags: ['Blockchain','Immobilier','Web3'], stat: 'Tokenise', img: 'assets/portfolio-glamhouse.jpg', url: 'https://glamhouse.188.245.182.200.sslip.io' },
        { title: 'Dr Psy Daniel', type: 'Site professionnel', desc: 'Site vitrine elegant pour un cabinet de psychanalyse. Prise de RDV en ligne, design sobre et professionnel.', color: '#00ff87', tags: ['Sante','SEO','Design'], stat: 'RDV en ligne', img: 'assets/portfolio-psydaniel.jpg', url: 'https://www.drpsydanielben.com' },
        { title: 'David Spectacles', type: 'Dashboard', desc: 'Dashboard de gestion de spectacles : planning artistes, annonces, billetterie et suivi complet.', color: '#ffd700', tags: ['Planning','Artistes','Dashboard'], stat: 'Live' },
        { title: 'Afrique Digital', type: 'Portail web', desc: 'Portail digital pour le marche africain francophone. Optimise mobile et marches emergents.', color: '#06b6d4', tags: ['Mobile-first','Portail','Afrique'], stat: 'Multi-pays' },
        { title: 'LaunchPad', type: 'Mini App', desc: 'MVP fonctionnel livre en 5 jours pour startups. Pret a tester sur le marche.', color: '#e879f9', tags: ['MVP','Startup','Rapide'], stat: '5 jours' }
    ];
    function cardHTML(p) {
